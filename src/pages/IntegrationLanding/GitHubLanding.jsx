    ...
    <div className="integ-mockup-outer" style={{ padding: '20px 24px 0' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '200px 1fr', gap: 16, paddingBottom: 20 }}>
        ...
        <div style={{ background: 'rgba(0,0,0,.02)', borderRadius: 10, padding: 16 }}>
          ...
          {[
            { name: 'GitHub', color: '#18181b', active: true },
            ...
            <div key={s.name} style={{
              ...
              background: s.active ? 'rgba(24,24,27,.04)' : 'transparent',
            }}>
        ...
        <div style={{ background: 'rgba(0,0,0,.02)', borderRadius: 10, padding: 20 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 12, color: 'var(--land-muted)', marginTop: 2, display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
                ...
                <span style={{ display: 'flex', gap: 4, alignItems: 'center' }}>
                  <span style={{ width: 5, height: 5, borderRadius: 5, background: '#18181b', opacity: 0.5 }} /> 14 Commits from GitHub
                </span>
              </div>
            </div>
          ...
          {[
            { cat: 'New Features', color: 'var(--land-teal)', items: ['AI-powered commit grouping for smarter categorization', 'OAuth integration for seamless GitHub login'] },
            { cat: 'Improvements', color: 'var(--land-sky)', items: ['Reduced generation time by 40%', 'Better markdown rendering in preview mode'] },
          ].map((g) => (
...
export default function GitHubLanding() {
  ...
  return (
    <div className="landing-root">
      <SEO
        title="GitHub Integration — AI Release Notes from Commits & PRs"
        description="Generate release notes from GitHub commits and pull requests automatically. AI-powered changelog from your Git history. Connect GitHub, generate, publish."
        keywords="github release notes, github changelog, github integration, generate release notes from github, github ai release notes, github release notes generator for free, ai tool to create changelog from git commits, how to generate release notes from commits, automated release notes github"
        canonical="https://releaslyy.com/integrations/github"
      />
        ...
        <div className="land-con" style={{ position: 'relative', zIndex: 2 }}>
          <FadeIn>
            <div style={{
              ...
              <Sparkles size={14} />
              GitHub Integration — Commits, PRs &amp; Tags
            </div>
          </FadeIn>
          ...
          <FadeIn delay={0.2}>
            <p className="land-hero-subtitle" style={{ fontSize: 18, color: 'var(--land-muted)', maxWidth: 580, margin: '0 auto 40px', lineHeight: 1.65 }}>
              Connect your GitHub repos, select commits or PRs, and let AI write polished release notes. Publish directly to GitHub Releases.
            </p>
          </FadeIn>
          ...
          <FadeIn>
            <div style={{ textAlign: 'center', marginBottom: 64 }}>
              ...
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 700, letterSpacing: '-.03em', marginTop: 12, color: 'var(--land-text)' }}>
                ...
                <span style={{ fontFamily: 'var(--land-serif)', fontStyle: 'italic', fontWeight: 400 }}>GitHub</span>
                {' '}releases
              </h2>
              <p style={{ fontSize: 16, color: 'var(--land-muted)', maxWidth: 520, margin: '16px auto 0', lineHeight: 1.6 }}>
                Pull commits from GitHub, generate with AI, publish everywhere.
              </p>
            </div>
          </FadeIn>
          <div className="integ-features-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 16 }}>
            {[
              { icon: <Sparkles size={20} />, title: 'AI Release Notes', desc: 'Analyzes commits, PRs, and tags — then writes human-readable summaries organized by feature area.', color: 'var(--land-accent)' },
              { icon: <Cable size={20} />, title: 'Multi-Source Ingestion', desc: 'Pull data from GitHub, Jira, and DevRev. Releaslyy unifies everything into a single release timeline.', color: 'var(--land-sky)' },
              { icon: <Send size={20} />, title: 'Publish to GitHub Releases', desc: 'Generate notes and publish directly to GitHub Releases with one click. Supports markdown formatting.', color: 'var(--land-teal)' },
            ].map((f, i) => (
      ...
      <section className="land-sec">
        <div className="land-con">
          ...
          <div className="integ-steps-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24 }}>
            {[
              { num: '01', title: 'Connect Your Tools', desc: 'Link your GitHub repos (and optionally Jira, DevRev). Releaslyy syncs your merges, PRs, and tags.', color: 'var(--land-sky)' },
              { num: '02', title: 'AI Analyzes Everything', desc: 'Our AI reads commits, pull requests, and tags to understand what shipped, why it matters, and who it affects.', color: 'var(--land-accent)' },
              { num: '03', title: 'Generate & Publish', desc: 'Review the AI draft, customize the tone, then publish -- to GitHub Releases, Slack, Jira, email, or your changelog page.', color: 'var(--land-warm)' },
            ].map((s, i) => (
            ...
            <div className="land-cta-box" style={{
              ...
              <div style={{ position: 'relative', zIndex: 2 }}>
                ...
                <p style={{ fontSize: 16, color: 'var(--land-muted)', maxWidth: 460, margin: '0 auto 32px', lineHeight: 1.6 }}>
                  Connect GitHub, let AI do the writing, and publish to GitHub Releases and everywhere else -- in seconds. Free to start, no credit card required.
                </p>
