    ...
    <div className="integ-mockup-outer" style={{ padding: '20px 24px 0' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '200px 1fr', gap: 16, paddingBottom: 20 }}>
        ...
        <div style={{ background: 'rgba(0,0,0,.02)', borderRadius: 10, padding: 20 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 12, color: 'var(--land-muted)', marginTop: 2, display: 'flex', gap: 12, alignItems: 'center', flexWrap: 'wrap' }}>
                ...
                <span style={{ display: 'flex', gap: 4, alignItems: 'center' }}>
                  <span style={{ width: 5, height: 5, borderRadius: 5, background: 'var(--land-sky)', opacity: 0.5 }} /> 12 Issues from Jira
                </span>
              </div>
            </div>
          ...
          {[
            { cat: 'New Features', color: 'var(--land-teal)', items: ['PROJ-101: AI-powered ticket categorization from Jira sprints', 'PROJ-102: OAuth integration for seamless Jira Cloud login'] },
            { cat: 'Improvements', color: 'var(--land-sky)', items: ['PROJ-103: Reduced sprint data sync time by 40%', 'PROJ-104: Better formatting for epic-level summaries'] },
          ].map((g) => (
...
export default function JiraLanding() {
  const navigate = useNavigate();

  return (
    <div className="landing-root">
      <SEO
        title="Jira Integration — AI Release Notes from Sprints & Issues"
        description="Generate release notes from Jira issues and sprints automatically. AI-powered changelog from Jira tickets. Connect Jira, generate, publish everywhere."
        keywords="jira release notes, jira changelog, jira integration, generate release notes from jira, jira ai release notes, jira sprint release notes, automated release notes jira, generate release notes from jira tickets, jira release notes generator for free"
        canonical="https://releaslyy.com/integrations/jira"
      />
        ...
        <div className="land-con" style={{ position: 'relative', zIndex: 2 }}>
          <FadeIn>
            <div style={{
              ...
              <Sparkles size={14} />
              Now supporting Jira Cloud &amp; Server
            </div>
          </FadeIn>
          ...
          <FadeIn delay={0.1}>
            <h1 style={{
              ...
              Generate Release Notes from Jira Issues{' '}
              <span style={{
          ...
          <FadeIn delay={0.2}>
            <p className="land-hero-subtitle" style={{ fontSize: 18, color: 'var(--land-muted)', maxWidth: 580, margin: '0 auto 40px', lineHeight: 1.65 }}>
              Connect your Jira workspace, and let AI transform your sprints, issues, and epics into beautiful, human-readable release notes in seconds.
            </p>
          </FadeIn>
          ...
          <FadeIn>
            <div style={{ textAlign: 'center', marginBottom: 64 }}>
              ...
              <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 700, letterSpacing: '-.03em', marginTop: 12, color: 'var(--land-text)' }}>
                ...
                <span style={{ fontFamily: 'var(--land-serif)', fontStyle: 'italic', fontWeight: 400 }}>Jira</span>
                {' '}releases
              </h2>
              <p style={{ fontSize: 16, color: 'var(--land-muted)', maxWidth: 520, margin: '16px auto 0', lineHeight: 1.6 }}>
                Pull issues from Jira, generate with AI, publish everywhere.
              </p>
            </div>
          </FadeIn>
          <div className="integ-features-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 16 }}>
            {[
              { icon: <Sparkles size={20} />, title: 'AI Release Notes', desc: 'Analyzes Jira issues, sprint items, and epics — then writes human-readable summaries organized by category.', color: 'var(--land-accent)' },
              { icon: <Cable size={20} />, title: 'Multi-Source Ingestion', desc: 'Pull data from Jira, GitHub, and DevRev. Releaslyy unifies everything into a single release timeline.', color: 'var(--land-sky)' },
              { icon: <Send size={20} />, title: 'Publish Everywhere', desc: 'Push generated notes to Jira releases, GitHub Releases, Slack channels, or changelog pages automatically.', color: 'var(--land-teal)' },
            ].map((f, i) => (
      ...
      <section className="land-sec">
        <div className="land-con">
          ...
          <div className="integ-steps-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24 }}>
            {[
              { num: '01', title: 'Connect Your Tools', desc: 'Link your Jira workspace (and optionally GitHub, DevRev). Releaslyy syncs your issues, sprints, and epics.', color: 'var(--land-sky)' },
              { num: '02', title: 'AI Analyzes Everything', desc: 'Our AI reads Jira issues, sprint items, and linked epics to understand what shipped, why it matters, and who it affects.', color: 'var(--land-accent)' },
              { num: '03', title: 'Generate & Publish', desc: 'Review the AI draft, customize the tone, then publish -- to Slack, GitHub Releases, Jira, email, or your changelog page.', color: 'var(--land-warm)' },
            ].map((s, i) => (
            ...
            <div className="land-cta-box" style={{
              ...
              <div style={{ position: 'relative', zIndex: 2 }}>
                ...
                <p style={{ fontSize: 16, color: 'var(--land-muted)', maxWidth: 460, margin: '0 auto 32px', lineHeight: 1.6 }}>
                  Connect Jira, let AI do the writing, and publish to Slack and everywhere else -- in seconds. Free to start, no credit card required.
                </p>
