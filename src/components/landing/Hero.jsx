...
function DashboardMockup() {
  return (
    <div style={{ padding: "20px 24px 0" }}>
      ...
      <div className="land-hero-mockup-grid" style={{ display: "grid", gridTemplateColumns: "220px 1fr", gap: 16, paddingBottom: 20 }}>
...
export default function Hero() {
  ...
  return (
    <section className="land-sec land-hero-sec" style={{ paddingTop: 160, paddingBottom: 60, textAlign: "center", overflow: "hidden" }}>
      ...
      <div className="land-con" style={{ position: "relative", zIndex: 2 }}>
        ...
        <FadeIn delay={0.2}>
          <p className="land-hero-subtitle" style={{ fontSize: 18, color: "var(--land-muted)", maxWidth: 560, margin: "0 auto 40px", lineHeight: 1.65 }}>
        ...
        <FadeIn delay={0.4}>
          <div className="land-hero-pills" style={{ display: "flex", gap: 8, justifyContent: "center", flexWrap: "wrap", marginTop: 36 }}>
            {SOURCES.map((s) => (
        ...
        <FadeIn delay={0.5}>
          <div className="land-hero-mockup" style={{
