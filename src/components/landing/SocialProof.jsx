  ...
  return (
    <section className="land-sec" style={{ paddingTop: 40, paddingBottom: 60 }}>
      <div className="land-con">
        ...
        <FadeIn delay={0.1}>
          <div className="land-social-logos" style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 48, flexWrap: "wrap", opacity: .25 }}>
        ...
        <FadeIn delay={0.2}>
          <div className="land-testimonial" style={{
